...
function List({ item, isDragging, handleDragging, handleUpdate }) {
        ...
        >
            {
                edit ? (
                    <div className={styles.titleedit}>
                        ...
                        <button  data-testid={`save-title-${item.title}`} disabled={newName.length === 0} onClick={handleSaveNewTitle} className={styles.savetitle}>Save Title</button>
                    </div>
                ) : (
                    <>
