    ...
    <Modal onClose={onClose}>
      <div className={styles.cardinfo}>
        <div className={styles.cardinfobox}>
          <div className={styles.cardinfoboxtitle}>
            <Type />
            <p>Title</p>
          </div>
          <CustomInput
        ...
        <div className={styles.cardinfobox}>
          ...
          <div className={styles.cardinfoboxlabels}>
        ...
        <div className={styles.cardinfobox}>
          ...
          <div className={styles.cardinfoboxprogressbar}>
            <div
              className={styles.cardinfoboxprogress}
              style={{
          ...
          <div className={styles.cardinfoboxtasklist}>
            {cardValues.tasks?.map((item) => (
              <div key={item.id} className={styles.cardinfoboxtaskcheckbox}>
                <input
                  type="checkbox"
